...
class Validator(serializers.Serializer):
    def __init__(self, instance=None, data=..., **kwargs):
        ...
        self.fields["status"] = serializers.ListField(child=serializers.ChoiceField([CustomerStatusEnum.ACTIVE, CustomerStatusEnum.INACTIVE]), required=False, allow_null=True)
