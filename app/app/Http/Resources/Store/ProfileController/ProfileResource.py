...
class ProfileResource(JsonResponse):
    def __init__(self, customer: Customer, status=200, safe=False, json_dumps_params=None, **kwargs):
        ...
        self.data = {
            ...
            "profile_images": FileableService().transformImagesByCollection(customer.fileable.all(), CollectionNameEnum.PROFILE_IMAGE, "store"),
        }
