...
class Story(models.Model):
    ...
    slug = models.CharField(db_index=True, unique=True, max_length=300, db_collation="utf8mb4_unicode_ci")
    name = models.CharField(unique=True, max_length=300, db_collation="utf8mb4_unicode_ci")
