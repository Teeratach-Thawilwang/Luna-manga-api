...
class Validator(serializers.Serializer):
    def __init__(self, instance=None, data=..., **kwargs):
        self.fields["customer_id"] = serializers.ListField(child=serializers.IntegerField(), required=True)
        ...
        self.fields["order_by"] = serializers.ListField(child=serializers.ChoiceField(OrderByEnum.list()), required=False, allow_null=True)
