...
class Validator(serializers.Serializer):
    def __init__(self, instance=None, data=..., **kwargs):
        ...
        self.fields["status"] = serializers.ListField(child=serializers.ChoiceField([CategoryStatusEnum.ACTIVE, CategoryStatusEnum.INACTIVE]), required=False, allow_null=True)
