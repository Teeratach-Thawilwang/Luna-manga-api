...
class Validator(serializers.Serializer):
    def __init__(self, instance=None, data=..., **kwargs):
        ...
        self.fields["status"] = serializers.ListField(child=serializers.ChoiceField(BannerStatusEnum.list()), required=False, allow_null=True)
        self.fields["type"] = serializers.ListField(child=serializers.ChoiceField(BannerTypeEnum.list()), required=False, allow_null=True)
